...
public class ContaJuridica extends ContaCorrente{
    ...
    public ContaJuridica(int id_cliente, String nome, String sexo, int celular, String email, String endereco, int numero, double saldo, Date data_criacao, int status, int id_conta_jur, String cnpj) {
